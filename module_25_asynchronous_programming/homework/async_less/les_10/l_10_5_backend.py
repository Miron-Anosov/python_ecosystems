...
from l_10_4_backend import DB_KEY, create_database_pool, destroy_database_pool
...
app = web.Application()
app.on_startup.append(functools.partial(create_database_pool, host='127.0.0.1', port=5432, user='postgres',
                                        password='postgres',
                                        database='favorites'))

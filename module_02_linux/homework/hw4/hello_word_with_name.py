...
def hello_world(name_user: str):
    ...
    # TODO Cтарайтесь не сокращать имена переменных, пишите их полными словами, это способствует лёгкости понимания
    #  кода. Выбирайте имена "говорящие" о назначении переменной.
